...
type
  TOrdem_Servico = class
    ...
    private
      ...
      function FecharOdemServico(out erro: String): Boolean;
...
begin
  try
    ...
    begin
      erro := 'Erro ao editar ordem de serviço ' + ex.Message;
      Result := False;
    end;
  end;
end;

function TOrdem_Servico.FecharOdemServico(out erro: string): Boolean;
var
  query : TFDQuery;
begin
  try
    ...
    with query do
      begin
        Active := False;
        SQL.Clear;
        SQL.Add('UPDATE ordem_servico SET DATA_FECHAMENTO = :DATA_FECHAMENTO WHERE ID_ORDEM_SERVICO = :ID_ORDEM_SERVICO');
    ...
    begin
      erro := 'Erro ao fechar ordem de serviço ' + ex.Message;
      Result := False;
    end;
  end;
end;
